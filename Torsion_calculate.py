...
if __name__ == "__main__":
    ...
    positive = np.loadtxt("data/HTI.edgelist", dtype=np.int64)
    fw = open("data/HTI_torsion_1-1.edgelist","w")
    G = nx.Graph()
    ...
    for i in tqdm.tqdm(range(len(adj_1))):
