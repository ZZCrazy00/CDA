...
def settings():
    ...
    parser.add_argument('--aggregator', choices=['GCN', 'GIN', 'GAT'], default='MLP',
                        help='Message passing framework adopted in TorGNN. Default is GCN.')

    parser.add_argument('--in_file', type=str,default='data/CDA.edgelist',
                        help='Path to data fold. e.g., data/CDA.edgelist')
    ...
    parser.add_argument('--hidden1', default=32,
                        help='Number of hidden units for encoding layer 1. Default is 32.')
...
def Create_model(args):
    ...
    model = TorGNN(aggregator=args.aggregator, feature=args.dimensions, hidden1=args.hidden1, decoder1=args.decoder1, dropout=args.dropout)
